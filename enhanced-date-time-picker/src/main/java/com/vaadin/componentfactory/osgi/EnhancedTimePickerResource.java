...
public class EnhancedTimePickerResource
        implements OsgiVaadinStaticResource, Serializable {

    @Override
    public String getPath() {
        return "/META-INF/resources/frontend/enhancedTimepickerConnector.js";
    }

    @Override
    public String getAlias() {
        return "/frontend/enhancedTimepickerConnector.js";
    }
